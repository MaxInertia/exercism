...
// func TestVerse(t *testing.T) {
// 	actual := Verse(testCases[0].input)
// 	if actual != testCases[0].expected {
// 		t.Errorf("Twelve Days test [%d], expected [%s], actual [%s]", testCases[0].input, testCases[0].expected, actual)
// 	}
// }
